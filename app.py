...
try:
    ...
    if not day_df.empty:
        ...
        # 吹き出しが上に見切れないよう位置を固定、または十分なマージンを確保
        fig_today.update_traces(hovertemplate="エリア: %{fullData.name}<br>価格: %{y:.2f}円<extra></extra>")
